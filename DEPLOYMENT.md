...
sudo service unicorn_uneeds <start|stop|restart>
sudo service sidekiq_uneeds <start|stop>
```
...
```
/home/deployer/apps/uneeds/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_uneeds restart
sudo service sidekiq_uneeds stop
sudo service sidekiq_uneeds start
```
