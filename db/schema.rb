...
ActiveRecord::Schema.define(version: 20180123030800) do
  ...
  create_table "high_transfers", force: :cascade do |t|
    t.bigint "user_id"
    t.float "amount"
    t.float "guaranteed_rate"
    t.integer "currency"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_high_transfers_on_user_id"
  end
